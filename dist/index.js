...
const ToolTip = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  React.useDebugValue(mount.current, value => value ? "Tooltip is mounted" : "Tooltip is unmounted");
  React.useDebugValue(show, value => value ? "Tooltip is visible" : "Tooltip is hidden");
  React.useDebugValue(rect, value => `rect: ${JSON.stringify(value)}`);
  React.useDebugValue(state, value => `state: ${JSON.stringify(value)}`);
  React.useDebugValue(showTimeoutRef.current, value => `showTimeoutRef: ${value}`);
  React.useDebugValue(hideTimeoutRef.current, value => `hideTimeoutRef: ${value}`);
  ...
  const handleShowTooltip = React.useCallback(evt => {
  ...
  const handleClearTooltip = React.useCallback(forceChangedelay => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, React.Children.map(props.children, (child, index) => {
    if (index === 0 && /*#__PURE__*/React.isValidElement(child)) {
      if (child.type !== React.Fragment) {
        return /*#__PURE__*/React.cloneElement(child, addPropsAndEventHandlers(child, props));
      } else {
        return /*#__PURE__*/React.createElement("div", _extends({}, show && {
          "aria-describedby": "tooltip",
          "data-testid": "tooltip-trigger"
        }, addEventHandlers(child, props)), /*#__PURE__*/React.cloneElement(child, {
          ...child.props
        }));
      }
    }
    return child;
  }), mount.current && show && props.show && /*#__PURE__*/reactDom.createPortal( /*#__PURE__*/React.createElement("div", {
    id: "tooltip",
